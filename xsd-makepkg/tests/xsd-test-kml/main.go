...
import (
	...
	kml "github.com/sablev/go-xsd-pkg/schemas.opengis.net/kml/2.2.0/ogckml22.xsd_go"
)
...
func main() {
	var (
		dirBasePath  = udevgo.GopathSrcGithub("sablev", "go-xsd", "xsd-makepkg", "tests", "xsd-test-kml")
